package Praktikum2.main.java.Aufgabe3;// Copyright (C) 1998-2001 Logi Ragnarsson

import java.util.Random;

/**
 * This is the class for Data Encryption Standard (Aufgabe3.DES) keys. See FIPS PUB 46-1
 * or DEA defined in ANSI X3.92-1981 for a complete specification.
 *
 * <p>
 * Aufgabe3.DES is the most widely used block cipher, although it is nowadays normally
 * used repeatedly for each piece of plain-text and is called triple-Aufgabe3.DES. This
 * is because the 56-bit key-size of the normal Aufgabe3.DES is too small to offer
 * complete security.
 * <p>
 * The CDS for a Aufgabe3.DES key is <code>Aufgabe3.DES(key)</code> with <code>key</code>
 * a string of 16 hexadecimal digits to create a specific key
 * or <code>Aufgabe3.DES(?)</code> for a random Aufgabe3.DES object.
 * <p>
...
public class DES
{
    ...
    /** Create a new random Aufgabe3.DES key. */
    public DES()
    {
    ...
    /** Create a new Aufgabe3.DES key with the key bits from <code>key[0..7]</code>. */
    public DES(byte[] key)
    {
    ...
    /** Create a new Aufgabe3.DES key with the key bits from <code>key</code>. */
    public DES(long key)
    {
        this.key = key;
        buildSubKeys();
    ...
    /** The block-size for the Aufgabe3.DES cipher is 8 bytes. */
    ...
    /** The key-size for the Aufgabe3.DES cipher is 56 bits. */
    public int getSize()
    {
        return 56;
    }
    ...
    /** The name of the algorithm is "Aufgabe3.DES". */
    ...
    {
        return "Aufgabe3.DES("+hexString(key)+")";
    }
